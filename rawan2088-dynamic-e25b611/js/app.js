...
let localReplays = JSON.parse(localStorage.getItem("replays"));
let replays = [];
if (localReplays != null) {
  replays.push(...localComments);
}

let commentSection = document.querySelector('.commentSection')
let replayDiv = document.querySelector('.replayDiv')

commentSection.addEventListener('click',(e)=>{

	if(e.target.className === 'replay'){
			replayDiv.innerHTML = `<form id='replayForm' action="" method="post">
					<input
					  required
					  type="text"
					  name="name"
					  ...
					  class="inputs"
					/>
					<p style="display: none" class="errorMsg">Please write a name</p>
					<input
					  required
					  type="email"
					  name="email"
					  ...
					  class="inputs"
					/>
					<p style="display: none" class="errorMsg">
					...
					></textarea>
					<p style="display: none" class="repErrorMsg">Please type a comment</p>
					<button type="submit" class="replayBtn" id="commentBtn">Comment</button>
				  </form>`
	}
		if(e.target.className === 'replayBtn'){
			e.preventDefault();
			let mainForm = document.querySelector("#replayForm");
			let userName = document.querySelector("#repUserName");
			let userEmail = document.querySelector("#repUserEmail");
			let textInput = document.querySelector("#repCommentText");
			let submitBtn = document.querySelector("#repCommentBtn");
...
function newReplay() {
  ...
  for (let user of replays) {
    let newComment = document.createElement("div");
    newComment.classList.add("replayCom");
	newComment.classList.add("comment");
